...
import static main.sql.DatabaseConnection.*;

public class ToSQL {
    private static ToSQL instance = null;
    ...
    public ToSQL() throws SQLException {
    ...
    public static ToSQL getInstance() throws SQLException {
        if (instance == null) {
            instance = new ToSQL();
        }
