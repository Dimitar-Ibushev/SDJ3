...
public class Embedded implements WebSocket.Listener {

    public Embedded() {
        HttpClient client = HttpClient.newHttpClient();
        CompletableFuture<WebSocket> ws = client.newWebSocketBuilder()
                .buildAsync(URI.create("https://iotnet.teracom.dk/apps/websocket.html?token=vnoSZwAAABFpb3RuZXQudGVyYWNvbS5kayi5FAHMm-UwpqqO3SN2YBc="), this);
    }
